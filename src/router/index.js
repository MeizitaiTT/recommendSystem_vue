    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: '/poi',
          name: 'PoiIndex',
          component: () => import('../components/poi/PoiIndex')
        },
        {
          path: '/poi/search',
          name: 'PoiSearch',
          component: () => import('../components/poi/PoiSearch')
        },
        {
          path: '/poi/recommend',
          name: 'PoiRecommend',
          component: () => import('../components/poi/PoiRecommend')
        },
        {
          path: '/graphic',
          name: 'PoiGraphic',
          component: () => import('../components/graphic/graphicIndex')
        }
      ]
    }
  ]
